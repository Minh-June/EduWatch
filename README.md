...
- Khởi tạo môi trường ảo (khuyến nghị): python -m venv venv.\venv\Scripts\activate
- Cài đặt danh mục thư viện phụ thuộc: pip install -r requirement.txt
3. Khởi tạo cơ sở dữ liệu
- Chạy lệnh khởi tạo cấu trúc cơ sở dữ liệu mẫu cho lần đầu vận hành: python init_db.py
